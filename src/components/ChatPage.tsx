...
import { isJsonFormatRequest, extractJsonContent, isIncompleteQuestion, isAPIQuestion, isBannerCommand, handleBannerCommand } from '../utils/chatUtils';
...
export function ChatPage({
  ...
  const scrollToBottom = React.useCallback(
    (force: boolean = false) => {
      requestAnimationFrame(() => {
        if (chatContainerRef.current && (isLoading || force)) {
  ...
  return (
    <div className="flex flex-col h-full relative">
      ...
      <div className="sticky bottom-0 left-0 right-0 flex-shrink-0 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-4">
        <ChatInput
